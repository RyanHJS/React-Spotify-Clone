 ...
 * Generic method type.
 */
export declare type SpotifyWebPlaybackMethod<T = void, R = void> = (args: T) => R;
/** @hidden */
export declare type SpotifyOAuthCallback = SpotifyWebPlaybackMethod<string, Promise<void>>;
/**
 * Status events.
 */
export declare type SpotifyWebPlaybackStatusType = 'ready' | 'not_ready';
/**
 * State change event.
 */
export declare type SpotifyWebPlaybackStateType = 'player_state_changed';
/**
 * Error events.
 */
export declare type SpotifyWebPlaybackErrorType = 'initialization_error' | 'authentication_error' | 'account_error' | 'playback_error';
/** @hidden */
 ...
 * Event callbacks.
 */
export declare type SpotifyListenerType = 'error' | 'state' | 'ready';
/**
 * An event listener for when an error occurs.
 */
export declare type SpotifyErrorListener = SpotifyWebPlaybackMethod<SpotifyWebPlaybackErrorType>;
/**
 * An event listener for when the playback state changes.
 */
export declare type SpotifyStateListener = SpotifyWebPlaybackMethod<SpotifyWebPlaybackState | null>;
/**
 * An event listener for when the player status changes.
 */
export declare type SpotifyStatusListener = SpotifyWebPlaybackMethod<SpotifyWebPlaybackStatusType>;
/**
 * Event listeners.
 */
export declare type SpotifyListener = SpotifyErrorListener | SpotifyStateListener | SpotifyStatusListener;
/** @hidden */
export declare type SpotifyErrorCallback = SpotifyWebPlaybackMethod<SpotifyWebPlaybackError>;
/** @hidden */
export declare type SpotifyStateCallback = SpotifyWebPlaybackMethod<SpotifyWebPlaybackState | null>;
/** @hidden */
export declare type SpotifyStatusCallback = SpotifyWebPlaybackMethod<SpotifyWebPlaybackReady>;
/** @hidden */
export interface SpotifyWebPlaybackPlayer {
    ...
    removeListener: (event: SpotifyWebPlaybackErrorType | SpotifyWebPlaybackStateType | SpotifyWebPlaybackStatusType, callback?: SpotifyWebPlaybackMethod) => boolean;
 ...
 */
export declare enum SpotifyDeviceType {
